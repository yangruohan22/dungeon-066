...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen w-full bg-[#f1f5f9] flex flex-col items-center justify-center p-4 font-sans">

      <div className="bg-white max-w-2xl w-full border-4 border-slate-900 rounded-3xl shadow-[12px_12px_0_#1e293b] p-10 md:p-16 text-center animate-in zoom-in duration-700 relative overflow-hidden">
        ...
        <div className="space-y-4 text-left bg-slate-50 border-4 border-slate-900 p-6 rounded-2xl mb-10">
          ...
          <p className="text-md font-bold text-slate-500 leading-relaxed">
            在这里，你可以为你的朋友量身定制一场属于ta的副本。你对ta了解越多，副本会越好玩哦~
          </p>
        </div>
